...
var ImportTransactionsService = /** @class */ (function () {
    ...
    ImportTransactionsService.prototype.execute = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionsRepository, categoryRepository, contactReadStream, parses, parseCSV, transactions, categories, existsCategories, existsCategoriesTitles, addCategories, newCategories, allCategories, newTransactions;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        contactReadStream = fs_1.default.createReadStream(filePath);
                        parses = csv_parse_1.default({
                            from_line: 2,
                        });
                        parseCSV = contactReadStream.pipe(parses);
                        transactions = [];
                        categories = [];
                    ...
                    case 2:
                        ...
                        newCategories = categoryRepository.create(addCategories.map(function (title) { return ({
                            title: title,
                        }); }));
                        return [4 /*yield*/, categoryRepository.save(newCategories)];
                    case 3:
                        _a.sent();
                        allCategories = __spreadArrays(existsCategories, newCategories);
                        newTransactions = transactionsRepository.create(transactions.map(function (transaction) { return ({
                            title: transaction.title,
                            type: transaction.type,
                            value: transaction.value,
                            category: allCategories.find(function (category) { return category.title === transaction.category; }),
                        }); }));
                        return [4 /*yield*/, transactionsRepository.save(newTransactions)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, fs_1.default.promises.unlink(filePath)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/, newTransactions];
                }
            });
        });
    };
