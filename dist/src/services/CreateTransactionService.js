...
var CreateTransactionService = /** @class */ (function () {
    ...
    CreateTransactionService.prototype.execute = function (_a) {
        var title = _a.title, value = _a.value, type = _a.type, categoryTitle = _a.categoryTitle;
        return __awaiter(this, void 0, void 0, function () {
            var transactionsRepository, categoryRepository, total, category, transaction;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!['income', 'outcome'].includes(type)) {
                            throw new AppError_1.default('Transaction type is invalid!');
                        }
                    ...
                    case 1:
                        total = (_b.sent()).total;
                        if (value > total) {
                            throw new AppError_1.default('This value is bigger then balance');
                        }
                        _b.label = 2;
